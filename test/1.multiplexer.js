...
describe('1. Test Multiplexer', () => {
  ...
  it('1.1 Can commission a new shard', async () => {
  ...
  it('1.2 Can decommission an existing pool', async () => {
  ...
  it('1.3 Can use the poll to make changes to the multiplexer', async () => {
